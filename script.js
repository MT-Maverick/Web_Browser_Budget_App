...
//Updates the UI: 
function updateUI() { Income = calculateTotal('income', ENTRY_LIST); Expenses = calculateTotal('expense', ENTRY_LIST); Balance = Math.abs(calculateTotalBalance(Income, Expenses)); 
